  ...
  return (
    <div className="text-white md:h-[380px] bg-[#343942] py-12 px-10 w-full ">
      <div className="flex flex-col md:flex-row items-center gap-6 border-b border-b-[#797E89] pb-7 mb-6">
        ...
        <div className="">
          <h3 className="font-bold text-2xl md:text-3xl font-cormorant">
            {name}
          </h3>
          <p className="text-lg md:text-xl font-josefin font-normal">
            {country}
          </p>
        </div>
      </div>
      <p className="text-xl md:text-[25px] italic ">{`"${comment}`}</p>
    </div>
  );
};
